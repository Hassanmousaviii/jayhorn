	...
	public BinaryExpression(SourceLocation loc, BinaryOperator op, Expression left, Expression right) {
		...
		Preconditions.checkArgument(
				left.getType().getClass() == right.getType().getClass()
						...
						|| (op == BinaryOperator.Ne && (left.getType() == DoubleType.instance() || left.getType() == FloatType.instance()))
						|| (op == BinaryOperator.Ne && (right.getType() == FloatType.instance() || right.getType() == DoubleType.instance()))
						...
						|| (op == BinaryOperator.MinusDouble && (left.getType() == DoubleType.instance() || right.getType() == DoubleType.instance()))
						|| (op == BinaryOperator.MinusFloat && (left.getType() == FloatType.instance() || right.getType() == FloatType.instance()))

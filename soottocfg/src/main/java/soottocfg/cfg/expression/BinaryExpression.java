...
public class BinaryExpression extends Expression {
	...
	public enum BinaryOperator {
		...
		StringLastIndexOf("<last_idx_of>"), StringLastIndexOfChar("<last_idx_of_char>"), ToDouble("<double>"), ToFloat("<float>"), AssumeDouble("<AssumeDouble>"),AssumeFloat("<AssumeFloat>"), MulDouble("<MulDouble>"), MulFloat("<MulFloat>"), AddDouble("<AddDouble>"), AddFloat("<AddFloat>"), LeDouble("<LeDouble>"), LeFloat("LeFloat");	// TODO: not an actual BinaryExpression

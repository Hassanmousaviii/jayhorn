...
class PredicateFun implements ProverFun {
    ...
    protected static void checkArgTypes(ProverType[] argTypes,
      ...
      for (int i = 0; i < argTypes.length; ++i)
        if (!argTypes[i].equals(args[i].getType()) && !argTypes[i].toString().equals("(_ BitVec 1)") && !argTypes[i].toString().equals("(_ BitVec 11)") && !argTypes[i].toString().equals("(_ BitVec 106)") && !argTypes[i].toString().equals("(_ BitVec 53)") && !argTypes[i].toString().equals("(_ BitVec 50)") && !argTypes[i].toString().equals("(_ BitVec 54)") && !argTypes[i].toString().equals("(_ BitVec 55)") && !argTypes[i].toString().equals("(_ BitVec 12)") && !argTypes[i].toString().equals("(_ BitVec 8)") &&  !argTypes[i].toString().equals("(_ BitVec 9)") && !argTypes[i].toString().equals("(_ BitVec 72)") && !argTypes[i].toString().equals("(_ BitVec 159)") && !argTypes[i].toString().equals("(_ BitVec 49)") && !argTypes[i].toString().equals("(_ BitVec 107)") && !argTypes[i].toString().equals("(_ BitVec 24)") && !argTypes[i].toString().equals("(_ BitVec 22)") && !argTypes[i].toString().equals("(_ BitVec 23)") && !argTypes[i].toString().equals("(_ BitVec 48)")  && !argTypes[i].toString().equals("(_ BitVec 51)") && !argTypes[i].toString().equals("(_ BitVec 52)"))
